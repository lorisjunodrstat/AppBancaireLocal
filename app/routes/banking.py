...
def dashboard_employes():
    ...
    if not contrat_model.user_has_types_cotisation_or_indemnite(cotisations_contrat_model=g.models.cotisations_contrat_model, indemnites_contrat_model=g.models.indemnites_contrat_model, current_user_id,):
